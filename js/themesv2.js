(() => {
  var e,
    ...
    i,
    s,
    r = document.getElementById("towerBarat"),
  ...
  $();
  var ee = document.querySelectorAll(".towerbarat_slide"),
    te = document.querySelectorAll(".towerbarat_menu_item"),
    ne = document.getElementById("smMenu"),
    oe = document.querySelector(".towerbarat_menu_list"),
